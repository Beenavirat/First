...
public class ProductDetailPage extends Utils {
    ...
    String _nonRegisterExpected = "Enter your email";
    private By _nonRegisterActul = By.id("Your Email address-error");
    ...
    public void UserReferToFriend() {
        ...
        enterText(_friendEmail, "vbeena55@yahoo.co.uk");
        //enter your email id
        enterText(_yourEmail, "testtest@yahoo.co.uk");
    ...
    public void verifyUserNotRegisterUserSeeErrorMessage() {
        assertTextMessage("fail", _nonRegisterExpected, _nonRegisterActul);
